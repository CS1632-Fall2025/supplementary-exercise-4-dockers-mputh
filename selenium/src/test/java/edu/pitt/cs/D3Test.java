...
public class D3Test {
  ...
  public void tEST1LINKS() {
    driver.get("http://localhost:8080/");
    {
      ...
      wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//header/span")));
    }
  ...
  public void tEST4LISTING() {
    ...
    vars.put("listCount", driver.findElements(By.xpath("//li[starts-with(@id, \'cat-id\')]")).size());
  ...
  public void tEST7RETURN() {
    ...
    {
      WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
      wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[contains(.,\'Rent-A-Cat\')]")));
    }
    driver.findElement(By.xpath("//a[contains(.,\'Rent-A-Cat\')]")).click();
    {
      WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
  ...
  public void tEST3CATALOG() {
    ...
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
    {
      ...
      vars.put("imgPath", attribute);
    }
    assertEquals(vars.get("imgPath").toString(), "http://localhost:8080/images/cat2.jpg");
  }
}
